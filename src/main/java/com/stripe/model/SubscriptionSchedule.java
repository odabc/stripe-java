...
public class SubscriptionSchedule extends ApiResource
  ...
  SubscriptionScheduleRevision.RenewalInterval renewalInterval;
  ...
  public SubscriptionSchedule create(Map<String, Object> params) throws StripeException {
    return create(params, (RequestOptions) null);
  }

  /** Creates a new subscription schedule object. */
  public SubscriptionSchedule create(Map<String, Object> params, RequestOptions options)
      throws StripeException {
    String url = String.format("%s%s", Stripe.getApiBase(), "/v1/subscription_schedules");
    return request(
  ...
  public static class Phase extends StripeObject {
    ...
    List<SubscriptionScheduleRevision.PhaseItem> plans;
