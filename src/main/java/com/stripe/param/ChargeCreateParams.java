...
public class ChargeCreateParams extends ApiRequestParams {
   ...
   * the funds from the charge will be transferred to the destination account. The ID of the
   * resulting transfer will be returned in the response's `transfer` field. For details, see
   * [Creating Destination Charges on Your Platform](/docs/connect/destination-charges).
   */
