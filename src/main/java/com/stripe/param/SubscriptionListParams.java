...
public class SubscriptionListParams extends ApiRequestParams {
  ...
  /**
   * The status of the subscriptions to retrieve. One of: `trialing`, `active`, `past_due`,
   * `unpaid`, `canceled`, or `all`. Passing in a value of `canceled` will return all canceled
   * subscriptions, including those belonging to deleted customers. Passing in a value of `all` will
   * return subscriptions of all statuses.
   */
  ...
  public static class Builder {
     ...
     * The status of the subscriptions to retrieve. One of: `trialing`, `active`, `past_due`,
     * `unpaid`, `canceled`, or `all`. Passing in a value of `canceled` will return all canceled
     * subscriptions, including those belonging to deleted customers. Passing in a value of `all`
