...
public class WebhookEndpointCreateParams extends ApiParamRequest {
  ...
  private WebhookEndpointCreateParams(
      Boolean connect, List<EnabledEvents> enabledEvents, List<String> expand, String url) {
  ...
  public static class Builder {
    ...
    public WebhookEndpointCreateParams build() {
      return new WebhookEndpointCreateParams(connect, enabledEvents, expand, url);
    }
