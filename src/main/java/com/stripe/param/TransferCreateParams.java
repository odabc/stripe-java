...
public class TransferCreateParams extends ApiRequestParams {
  ...
  /**
   * The source balance to use for this transfer. One of `card`, `financing`, `bank_account`, or
   * `alipay_account`. For most users, this will default to `card`.
   */
  ...
  public static class Builder {
     ...
     * calls adds additional elements to the original list. See {@link TransferCreateParams#expand}
