...
public class SourceUpdateParams extends ApiParamRequest {
  ...
  private SourceUpdateParams(
      List<String> expand, Mandate mandate, Map<String, String> metadata, Owner owner) {
    this.expand = expand;
  ...
  public static class Builder {
    ...
    public SourceUpdateParams build() {
      return new SourceUpdateParams(expand, mandate, metadata, owner);
    }
