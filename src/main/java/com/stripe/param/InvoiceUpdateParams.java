...
public class InvoiceUpdateParams extends ApiRequestParams {
   ...
   * collection](/docs/billing/invoices/workflow/#auto_advance) of the invoice.
   */
  ...
  public static class Builder {
     ...
     * calls adds additional elements to the original list. See {@link InvoiceUpdateParams#expand}
