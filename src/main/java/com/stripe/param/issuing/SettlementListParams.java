...
@Getter
public class SettlementListParams extends ApiRequestParams {
  /**
  ...
  public static Builder builder() {
    return new com.stripe.param.issuing.SettlementListParams.Builder();
  }
  ...
  public static class Builder {
    ...
    public SettlementListParams build() {
      return new SettlementListParams(
     ...
     * SettlementListParams#expand} for the field documentation.
     */
