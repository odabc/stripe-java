  ...
  public static class Builder {
    ...
    public CardUpdateParams build() {
      return new CardUpdateParams(
          this.authorizationControls, this.cardholder, this.expand, this.metadata, this.status);
    }

    /**
     * Add an element to `expand` list. A list is initialized for the first call, and subsequent
     * calls adds additional elements to the original list. See {@link CardUpdateParams#expand} for
    ...
    public static class Builder {
      ...
      public AuthorizationControls build() {
        return new AuthorizationControls(
            this.allowedCategories, this.blockedCategories, this.maxAmount, this.maxApprovals);
      }
